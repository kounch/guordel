...
#autostart
 ...
 350 LET R=PEEK A*VAL"256"+PEEK B:IF R=VAL"65535" THEN GO TO 450:REM NOT A VALID WORD >:-|
 360 LET T=T+VAL"1"
 ...
 430 NEXT L
 440 PAPER I:INK S:PRINT G$(J TO J);:INK I:PAPER P:NEXT J
 450 PRINT AT T+VAL"4",VAL"13";:IF T<VAL"6" THEN GO TO 310
