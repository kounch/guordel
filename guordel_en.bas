...
#autostart
  ...
  10 CLEAR VAL "40959":LET I=NOT PI:LET P=VAL"7":LET O=VAL"4":LET K=VAL"2":LET Y=VAL"6"
 ...
 110 PRINT AT VAL"8",VAL"6";"COUNTING WORDS... ";:POKE A,NOT PI:POKE B,NOT PI:RANDOMIZE USR C:PRINT "OK"
 120 LET M=PEEK A*VAL"256"+PEEK B:PRINT AT VAL"10",VAL"10";"FOUND: ";M
 130 LET N=PEEK E*VAL"256"+PEEK (E+VAL"1"):PRINT AT VAL"12",VAL"10";N;" TO GUESS"
 ...
 280 PLOT VAL"102",VAL"145":DRAW VAL"43",NOT PI:DRAW NOT PI,VAL"-51":DRAW VAL"-43",NOT PI:DRAW NOT PI,VAL"51"
 290 PLOT VAL"43",VAL"59":DRAW VAL"161",NOT PI:DRAW NOT PI,VAL"-49":DRAW VAL"-161",NOT PI:DRAW NOT PI,VAL"49"
 ...
 510 BORDER I
 520 IF G$=W$ THEN BORDER P:INK O:PRINT G$:INK O:PRINT AT VAL"12",VAL"10";"SUCCESS! :-)":INK I:GO TO 670
