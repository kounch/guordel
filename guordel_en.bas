...
#autostart
  ...
  10 CLEAR VAL "40959":LET I=NOT PI:LET P=VAL"7":LET O=VAL"4":LET K=VAL"2":LET Y=VAL"6":DIM Z(27)
  20 LET D=VAL"47096":LET A=D+VAL"6":LET B=A+VAL"1":LET C=VAL"40960":LET E=VAL"44544":LET F=VAL"43776"
