...
#autostart
  ...
  30 LET A=VAL"48126":LET B=VAL"48127":LET C=VAL"42484":LET E=VAL"45566"
  ...
  70 PRINT AT VAL"8",VAL"12";" SOLS...":INK I:LOAD"wordss"CODE E:INK P
  80 PRINT AT VAL"8",VAL"12";"BASIC...":INK I:LOAD"basic"
