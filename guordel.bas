...
#autostart
  ...
  20 LET D=VAL"43897"-VAL"1":LET A=D+VAL"6":LET B=A+VAL"1":LET C=VAL"35840":LET E=VAL"39168"
  ...
  60 PRINT AT VAL"1",VAL"8";"** ZX GUORDEL **":PRINT #0;AT VAL"1",VAL"2";"(C) kounch  2022":PRINT #0;AT VAL"1",VAL"25";"V1.1"
 ...
 130 IF K$="S" OR K$="M" THEN GO TO 700
