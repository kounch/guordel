...
#autostart
 ...
 190 IF K$="S" OR K$="s" THEN GO TO 700
 ...
 660 GO TO 200
 700 INK P:PAPER VAL"1":BORDER VAL"1":CLS:PRINT AT VAL"10",VAL"2";"Dedicado a Sara y Montse :-*":PAUSE 0:INK I:PAPER P:BORDER P:CLS:GO TO 130
